      ...
      <div className="space-y-4">
        ...
        <div className="glass-card border border-white/10 rounded-2xl p-5 sm:p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-sm font-bold text-on-surface uppercase tracking-wide">Account</h2>
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between py-2 border-b border-white/5">
              <span className="text-sm text-on-surface-variant">Role</span>
              <span className="text-sm font-medium text-on-surface">Staff Member</span>
            </div>
            <div className="flex items-center justify-between py-2 border-b border-white/5">
        ...
        <div className="glass-card border border-red-500/20 rounded-2xl p-5 sm:p-6">
          <h2 className="text-sm font-bold text-on-surface uppercase tracking-wide mb-1">Sign Out</h2>
          <p className="text-xs text-on-surface-variant mb-4">
            Signing out will end your current session. Make sure you've stopped all timers before leaving.
          </p>
          <button
