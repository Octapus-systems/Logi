    ...
    <div className="min-h-[80vh] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-on-surface-variant text-sm sm:text-base max-w-md mb-8">
          The <strong className="text-on-surface">Tasks Management</strong> section is currently under development.
          For now, you can assign tasks directly from the Dashboard.
        </p>
